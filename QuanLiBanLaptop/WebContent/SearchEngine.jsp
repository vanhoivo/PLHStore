            ...
            <div id="Feature">
                <form class="form-inline" autocomplete="on">
                    <div class="input-group mb-2 mr-sm-2">
                        <input autofocus type="search" class="border-success form-control" name="iptSearch" placeholder="Nhập thông tin ...">
                        <div class="input-group-append">
                            <button class="btn btn-success" type="submit" name="btnSearch"><i title="Tìm kiếm" class="fas fa-search"></i>Tìm
                                kiếm</button>
                        </div>
                    </div>
                    ...
                    <div class="ml-auto">
                        <button class="ml-auto btn btn-success mb-2" type="button" name="btnReload" onClick="window.location.reload()"><i title="Tải lại" class="fas fa-sync-alt"></i>Tải
                            lại</button>
                        <button class="ml-auto btn btn-success mb-2" type="button" name="btnAdd" data-toggle="modal"
                            data-target="#ModalAdd"><i title="Thêm mới" class="fas fa-plus-circle"></i>Thêm
                            mới</button>
                    </div>
                </form>
            ...
            <div id="DataView">
                <div class="table-responsive-md">
                    <table class="table table-striped table-hover border border-primary table-bordered">
                        <caption><i>Tổng số: <b><c:out value="${fn:length(listResults)}"></c:out></b>/<b><c:out value="${fn:length(listResults)}"></c:out></b></i></caption>
                        ...
                        <tbody>
							<c:forEach var="nguoidung" items="${listResults}">
								<tr>
									...
									<td>
										<i title="Xem thêm" class="fas fa-eye"></i> <i
										title="Xóa bỏ" class="fas fa-trash-alt" data-toggle="modal"
										data-target="#ModalDelete"></i> <i title="Chỉnh sửa"
										class="fas fa-edit" data-toggle="modal"
										data-target="#ModalEdit"></i>
										
										<a href="XoaND?mand=<c:out value='${nguoidung.mand}'></c:out>">Delete</a>
										<a href="SuaND?mand=<c:out value='${nguoidung.mand}'></c:out>">Edit</a>
									</td>
								</tr>
							</c:forEach>
                        </tbody>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button form="FormAdd" type="submit" class="btn btn-primary" name="btnSaveAdd"><i title="Lưu lại" class="far fa-save"></i>Lưu</button>
            ...
            <div class="modal fade" id="ModalEdit">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="btnSaveEdit"><i title="Lưu lại" class="far fa-save"></i>Lưu</button>
            ...
            <div class="modal fade" id="ModalDelete">
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="btnSaveDelete"><i title="Lưu lại" class="far fa-save"></i>Xóa</button>
