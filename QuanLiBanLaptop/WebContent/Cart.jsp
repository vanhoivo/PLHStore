...
<body>
	...
	<div class="container">
		<c:if test="${giohang !=null }">
		<div class="row">
			<h4>Giỏ hàng của bạn (<b>${giohang.listSanPham.size()}</b> sản phẩm)</h4>
		</div>

			<c:forEach var="sp" items="${giohang.listSanPham }">
				<div class="row" style="width: 80%; margin: 0 auto 10px auto; height: 200px; border-bottom: solid 1px;">
					<div class="col-lg-2" style="margin-top: 20px">
						<img src="${sp.hinh}" alt="" style="width: 100%; height: 100% px">
					</div>
					<div class="col-lg-3">
						<h3 style="margin-top: 40px">
							<a href="/may-tinh-xach-tay/dell-inspiron-n3576s" target="_blank">${sp.sanpham.tensp}</a>
						</h3>
					</div>
					<div class="col-lg-4">
					...
					<div class="col-lg-2">
						<form style="margin-top: 40px;">
							<input type="number" value="${sp.soluong}" min="1" max="5">
						</form>
					</div>
					<div class="col-lg-1">
						<a href="DeleteGioHang?masp=${sp.sanpham.masp}"><span
			...
			<div class="row" style="width: 80%; margin: 0 auto;">
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"
					style="float: right;">
					<label style="font-size: 18px; color: black; width: 100%;">Tổng
						tiền: ${giohang.tongtien} <sup>đ</sup></label> <br /> <a href="CheckLogin"><button
							class="btn btn-danger" style="width: 100%">Đặt hàng</button></a>
				</div>
			</div>
		</c:if>
		<c:if test="${giohang == null }">
