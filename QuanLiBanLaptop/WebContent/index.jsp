	...
	<div class="container">
		<div class="row">
			<div class="navbar-header col-lg-4" style="padding-left: 0px">
				<a class="navbar-brand" href="index.html" title="PLH Store"><img
					src="images/IMG_Company_Blur.png" alt="IMG_Branch"></img></a>
			</div>

			<div class="col-lg-4">
				<form class="navbar-form " action="timkiem" autocomplete>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Search"
							name="tukhoa" autofocus>
					</div>
					...
					<ul class="nav navbar-nav navbar-right">
						<c:if test="${giohang !=null }">
							<li><a href="Cart.jsp"><span
									class="glyphicon glyphicon-shopping-cart"></span> Cart (<b>${giohang.listSanPham.size()}</b>)</a></li>
						</c:if>

						<c:if test="${giohang ==null }">
							<li><a href="Cart.jsp"><span
									class="glyphicon glyphicon-shopping-cart"></span> Cart (<b>0</b>)</a></li>
						</c:if>
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"
				...
				<div class="list-group">	
					<a href="" class="list-group-item"
						...
						<a href="laptop-choi-game" class="list-group-item list-group-item-info" id="ASUS">Chơi Game</a> 
						<a href="laptop-van-phong" class="list-group-item list-group-item-info">Văn Phòng</a>
						<a href="laptop-doanh-nhan" class="list-group-item list-group-item-info">Doanh Nhân</a> 
						<a href="laptop-hoc-tap" class="list-group-item list-group-item-info">Học tập</a> 
						<a href="laptop-2-trong-1" class="list-group-item list-group-item-info">2 Trong 1</a>
				</div>
			</div>
			<!-- /end catalog -->
			<!-- /start slide -->
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="thumbnail" style="height: 578px; margin-top: 90px">
					...
					<div class="caption text-center">
						...
						<p>${sanpham.dongia }</p>
						<p>
							<a href="addGioHang?masp=${sanpham.masp}" class="btn btn-primary">Chọn mua</a> <a
										href="LoadChiTietSP?masp=${sanpham.masp }" class="btn btn-default">Chi tiết</a>
						</p>
					</div>
				</div>
			</div>
